...
const featureTable = [
  ...
  { feat: 'сonjunctionType', featMi: null, vesum: 'coord', mte: 'c' },
  { feat: 'сonjunctionType', featMi: null, vesum: 'subord', mte: 's' },
...
const mapVesum: Map<string, Object> = indexTableByColumn(featureTable, 'vesum');
