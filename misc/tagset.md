...
- Граматичні риси
  ...
  - Додаткові частини мови
    ...
    - [`&noun` Прикетниковий іменник](#noun2)
...
|`compb`|compare base|базова|
|`compr`|compare relative|вища|
|`super`|super|найвища|
...
||короткість||
|---|---|---|
|*(без тега)*|звичайний|зелений `adj:m:v_naz:compb`|
|`short`|короткий|зелен `adj:m:v_naz:short`|

|||стягненість||
|---|---|---|---|
|*(без тега)*||стягнений|зелена `adj:f:v_naz:compb`|
|`uncontr`|uncontracted|нестягнений|зеленая `adj:f:v_naz:uncontr:compb`|
...
### `&numr`/`&_numr` **Порядковий числівник**

Додається до `adj`, наприклад: двадцятий `adj:m:v_naz:&numr`.

Нижня риска в `&_numr` є семантичною. Вона вказує, що слово може вживатися в нечислівниковому сенсі: багатотисячне військо (не за ліком). Не зважайте на цю риску.

<a name="noun2"></a>
&nbsp;

### `&noun` **Прикетниковий іменник**
